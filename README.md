...
The Problem: "Helping Nigerian SMEs transition from expensive diesel generators to cost-effective solar solutions."

Key Features:  Dynamic Solar Sizing Algorithm.
10-Year Financial ROI Projection (Solar vs. Diesel).
Vendor Matching based on Geography and System Capacity.
Automated Quote Request Persistence.

Tech Stack: Node.js, FileSystem (FS) API for data persistence, JSON.
